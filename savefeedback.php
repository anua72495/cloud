<?php
	...
	$qry="insert into Feedback values(" . $suppId . ",'" .  date('Y-m-d') . "','" . $cname . "','" . $street . "','" . $Addr . "','" . $Cty . "','" . $Mob . "','" . $Ph . "','" . $Mail . "','" . $Description . "')";
/*echo $qry;
return;*/
...
<h2 align="center"><font face="Monotype Corsiva" color="Red">Feedback</font></h2>
...
Feedback made successfully.</font>
</td>	
