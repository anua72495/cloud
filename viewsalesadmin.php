...
$sql = "Select BillNo,BillDate,A.CustomerId,A.CustomerName,NetAmount From Customer A,SalesMaster B where A.CustomerId=B.CustomerId and BillDate Between '" . $FromDate . "' and '" . $ToDate . "'";
