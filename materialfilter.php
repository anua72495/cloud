<?php
	...
	$sql="select * from Material left join Agency  on Material.AgencyId=Agency.AgencyId ORDER BY SalesRate DESC";
	$rs= mysqli_query($con,$sql);
	}
	else
	{
		$sql="select * from Material left join Agency  on Material.AgencyId=Agency.AgencyId ORDER BY SalesRate ASC";
	$rs= mysqli_query($con,$sql);
	}
	//echo "<html>
...
<?php
echo"<form action='viewmaterialscustomer.php' method='post'>";
...
echo "<td valign='top' align='center'>";
	...
	echo"<h3 align=center><font face='TAHOMA' color=blue>High To Low /Low To High Price </font></h3>";
