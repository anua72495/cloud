...
function check()
{
	...
	if(document.f1.customername.value=="")
	{
...
<tr><td align="center" valign="top">
	<h1 align="center"><font face="TAHOMA" >CUSTOMER REGISTRATION</font></h1>
			...
			<form name="f1" id="f1" action="savecustomer.php" method="post">
			<table class='table table-striped table-hover' align="center" width="500">
				<tr>
					<td align="right">Customer Code/Id
