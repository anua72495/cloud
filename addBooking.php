...
$sql="Select SNo,A.ItemCode,ItemName,Quantity,Rate,Amount,Tax,TaxValue,NetTotal From RawMaterial A,PurchaseTrans B where A.ItemCode=B.ItemCode and B.BillNo=" . $RecNo;
$res=mysqli_query($con,$sql) or die(mysql_error());
...
<tr><td>
			...
			<tr>
				...
				<tr>
					<td align="right">Qty
					<td><input name="txtQty"  style="text-align:right;" onblur="calc()">
				</tr>
				<tr>
					<td align="right">Rate
					<td><input name="txtRate"  style="text-align:right;background-color:#AAAAAA;color:white" onkeypress="javascript:return false;" value=<?php echo $cnt;?>></td>
				</tr>
				<tr>
					<td align="right">Amount
					<td><input name="txtAmount"  style="text-align:right;background-color:#AAAAAA;color:white" onkeypress="javascript:return false;" value="0"></td>
				</tr>
					<tr>
					<td align="right">Tax %
					<td><input name="txtTax" style="text-align:right;" onblur="calc2()">
				</tr>
				<tr>
					<td align="right">Tax Amount
					<td><input name="txtTaxAmount"  style="text-align:right;background-color:#AAAAAA;color:white" onkeypress="javascript:return false;" value=''></td>
				</tr>
				<tr>
					<td align="right">Net Amount
					<td><input name="txtNetAmount"  style="text-align:right;background-color:#AAAAAA;color:white" onkeypress="javascript:return false;" value="0"></td>
				</tr>
				<tr>
