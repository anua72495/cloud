...
echo "	<table class='table table-striped table-hover' align='center' cellspacing='0' cellpadding='0' width='100%' border='1'>";
echo "	<tr><td>";
...
echo "<td valign='top' align='center'>";
	echo "<h1 align=center><font face='TAHOMA' color=white>SUPPLIERS DETAILS</font></h1>";
	
	echo "<table class='table table-striped table-hover' border=1 width='100%' cellpadding='1' cellspacing='0'>";

	echo "<tr><th>SUPPLIER ID</th><th>NAME</th><th>STREET</th><th>ADDRESS</th><th>CITY</th><th>PINCODE</th><th>PHONE</th><th>MOBILE</th><th>MAIL ID</th></tr>";
...
if($cnt%2==0)
	...
	echo "<tr><td align=center>" . $row['SupplierId'] . "</td><td bgcolor=yellow>" . $row['SupplierName'] . "</td><td>" . $row['Street'] . "</td><td>" . $row['Address']. "</td><td>" . $row['City'] . "</td><td>" . $row['PinCode'] . "</td><td bgcolor=yellow>" . $row['Phone'] . "</td><td>" . $row['Mobile'] . "</td><td>" . $row['EmailId'] . "</td></tr>";
	}
