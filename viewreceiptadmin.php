...
$sql = "Select ReceiptNo,ReceiptDate,A.CustomerId,A.CustomerName,Amount,ReceiptMode,Details From Customer A,Receipt B where A.CustomerId=B.CustomerId and ReceiptDate Between '" . $FromDate . "' and '" . $ToDate . "'";
