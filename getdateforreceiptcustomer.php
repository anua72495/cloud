...
echo "<center>";
echo "<form name=f1 method=post action=viewreceiptcustomer.php>";
...
echo "<td valign='top' align='center'>";
	echo "<h2 align=center><font face='TAHOMA' color=White>RECEIPT DATE</font></h2>";
	
	echo "<table class='table table-striped table-hover' border=1 width='300' cellpadding='1' cellspacing='0'>";
?>
<tr><td>Receipt Date From</td><td><input type=text name='txtFromDate' value='<?php echo date('Y-m-d'); ?>'></td></tr>
<tr><td>Receipt Date To</td><td><input type=text name='txtToDate' value='<?php echo date('Y-m-d'); ?>'></td></tr>
