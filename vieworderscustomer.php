...
$sql = "Select OrderNo,OrderDate,A.CustomerId,A.CustomerName,Quantity,Price,Total From Customer A,Orderdetails B where A.CustomerId=B.UserName and OrderDate Between '" . $FromDate . "' and '" . $ToDate . "' and CustomerId='". $_SESSION['customerid'] . "'";
